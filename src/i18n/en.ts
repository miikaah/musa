export default {
  ...
  "coverInfo.metadata.bitRate": "Bit rate",
  "coverInfo.metadata.sampleRate": "Sample rate",
  "library.filter.placeholder": "Filter by artist",
  "modal.closeButton": "Close",
  "modal.metadata.title": "Details",
  "modal.metadata.tag.artist": "Artist",
  "modal.metadata.tag.title": "Title",
  "modal.metadata.tag.album": "Album",
  "modal.metadata.tag.year": "Year",
  "modal.metadata.tag.track": "Track",
  "modal.metadata.tag.tracks": "Tracks",
  "modal.metadata.tag.disk": "Disk",
  "modal.metadata.tag.disks": "Disks",
  "modal.metadata.tag.genre": "Genre",
  "modal.metadata.tag.composer": "Composer",
  "modal.metadata.tag.codec": "Codec",
  "modal.metadata.tag.comment": "Comment",
  "modal.metadata.detail.fileUrl": "File URL",
  "modal.metadata.detail.coverUrl": "Cover URL",
  "modal.metadata.detail.duration": "Duration",
  "modal.metadata.detail.sampleRate": "Sample rate",
  "modal.metadata.detail.bitRate": "Bit rate",
  "modal.metadata.detail.channels": "Channels",
  "modal.metadata.detail.codec": "Codec",
  "modal.metadata.detail.codecDetails": "Codec, profile, container",
  "modal.metadata.detail.tagTypes": "Tag types",
  "modal.metadata.detail.encoding": "Encoding",
  "modal.metadata.detail.encodingLossless": "lossless",
  "modal.metadata.detail.encodingLossy": "lossy",
  "modal.metadata.detail.encoder": "Encoder",
  "modal.metadata.detail.encoderSettings": "Encoder settings",
  "modal.metadata.detail.drTrack": "DR track",
  "modal.metadata.detail.drTrackDetails": "Dynamic range of track",
  "modal.metadata.detail.drAlbum": "DR album",
  "modal.metadata.detail.drAlbumDetails": "Dynamic range of album",
  "modal.metadata.detail.normalizationTrack": "Normalization track",
  "modal.metadata.detail.normalizationTrackDetails": "Normalization of track",
  "modal.metadata.detail.normalizationAlbum": "Normalization album",
  "modal.metadata.detail.normalizationAlbumDetails": "Normalization of album",
  "modal.metadata.saving": "Saving...",
